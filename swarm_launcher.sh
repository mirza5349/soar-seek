...
ROS_DOMAIN=10
DDS_PORT=8889
# Lockstep at real time: a higher speed factor makes the sim clock race ahead
# during light phases, which magnifies wall-domain node latencies into multiple
# sim-seconds of timestamp skew between topics (incoherent logs).
